...
export declare type categoriesPk = "id";
export declare type categoriesId = categories[categoriesPk];
export declare type categoriesOptionalAttributes = "id" | "category";
export declare type categoriesCreationAttributes = Optional<categoriesAttributes, categoriesOptionalAttributes>;
export declare class categories extends Model<categoriesAttributes, categoriesCreationAttributes> implements categoriesAttributes {
    id: number;
    category?: string;
    post_id_posts: post[];
