...
export declare type postPk = "id";
export declare type postId = post[postPk];
export declare type postOptionalAttributes = "id" | "contents" | "price" | "createdAt" | "updatedAt" | "image_src";
export declare type postCreationAttributes = Optional<postAttributes, postOptionalAttributes>;
